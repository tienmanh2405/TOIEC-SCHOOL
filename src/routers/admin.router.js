...
import { createAdmin, deleteAdmin, getAdmins, getAdminById, loginAdmin, requestRefreshTokenAdmin, updateAdmin, createGiangVien } from '../controllers/admin.controller.js';
...
// Get admin by ID
router.get('/:MaQuanLy', getAdminById);
